...
# Script: quick create polygon
# Author: George Kipp
# Created Date: June 19th, 2015
# Last Modified Date: June 19th, 2015
# Description: allows user to quickly create a polygon feature class with only name, output workspace, and coordinate
# as input.
...
# poly_name - out name concatenated with appropriate extension
# new_poly - new line feature class
...
try:
    poly_name = out_name + gdb_check()
    new_poly = arcpy.CreateFeatureclass_management(out_workspace, poly_name, "POLYGON", "", "DISABLED", "DISABLED", coord_sys)
    arcpy.AddMessage("Successfully created polygon.")
except:
